defmodule Memelex.Environment.TreeTopSuprvsr do
  use Supervisor
  ...
  def init(memex_env) do
    children = [
      ...
      # also this is a bad idea in the sense that Memelex.Environment should start the tasks, link it to them, and handle that failure...
