...
#   # def note(contents), do: start_buffer_process({Franklin.Buffer.Note, contents})

#   # def list(:notes),   do: start_buffer_process({Franklin.Buffer.List, :notes})

#   # private functions

#   defp start_buffer_process(args), do:
