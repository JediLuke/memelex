defmodule Memelex.Environment.MiddleSupervisor do
  ...
  def init(init_arg) do
    ...
    # for now, only WikiServer & AgentServer are allowed to be running at the same time
    DynamicSupervisor.init(max_children: 2, strategy: :one_for_one)
  end
